...
<div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
    <div>
        ...
        <p class="text-secondary mb-0">Categorias utilizadas nos registos de atendimento.</p>
    </div>
...
<div class="card border-0 shadow-sm mb-4 d-none" id="cardFormulario">
    <div class="card-body">
        ...
        <form id="formTipo">
            <input type="hidden" name="id" id="tipold">
            <div class="row g-3">
                <div class="col-md-6">
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody id="tabelaTipos">
                <tr>
                    <td colspan="4" class="text-center py-4">Carregando registos...</td>
                </tr>
            </tbody>
        </table>
    </div>
...
const campoTipold = document.getElementById('tipold');
